...
/*===============================================================================================================
 ...
 |      Modified by: 0xAC (0xacioi@gmail.com)
 |      This version is modified for especial use in the AR Module.
 |==================================Usage========================================================================
...
{
    public static void ExportOBJ(string exportPath, string rootObjectName, bool applyPosition=true, bool applyRotation=true, bool applyScale=true, bool generateMaterials=true, bool exportTextures=true, bool splitObjects=true, bool autoMarkTexReadable=true, bool objNameAddIdNum=true)
    { 
        //init stuff
        ...
        {
            if (meshFilter.gameObject.layer == targetLayer)
            {
                filteredMeshFilters.Add(meshFilter);
            }
        }

        MeshFilter[] sceneMeshes = filteredMeshFilters.ToArray();
